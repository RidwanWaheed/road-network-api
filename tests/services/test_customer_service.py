...
def test_create_customer():
    ...
    mock_repo.create.return_value = MagicMock(id=1, name="Test Customer", api_key="generated_key")
...
def test_create_customer_with_api_key():
    ...
    # Mock the repository create method
    mock_repo.create.return_value = MagicMock(id=1, name="Test Customer", api_key="provided_key")
